...
export default async function PassportsPage() {
  ...
  // Non-critical: if passports query fails, show empty state
  let passports: unknown[] = [];
  try {
    ...
    console.error("[PassportsPage] passports query failed:", err);
  }
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <PageHeader
        title="Passports"
        description={`${passports.length} Digital Product Passports`}
        actions={
